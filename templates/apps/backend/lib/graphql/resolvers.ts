...
export const resolvers = {
    ...
    Query: {
        ...
        accessStats: async (_: unknown, __: unknown, context: Context) => {
            ...
            const [totalAccesses, uniqueUsers, uniqueDevices, platformStats, recentActivity, hourlyStats] =
                await Promise.all([
    ...
    Mutation: {
        ...
        updateUserRole: async (
            ...
            const normalizedRole = (roleKey && APP_ROLES[roleKey]) || (role.toLowerCase?.() as AppRole | undefined);
