      ...
      >
        {rgb.map((value, index) => (
          <Input
            ...
            // biome-ignore lint/suspicious/noArrayIndexKey: RGB components are fixed order
            key={index}
            readOnly
            type="text"
            value={value}
      ...
      >
        {hsl.map((value, index) => (
          <Input
            ...
            // biome-ignore lint/suspicious/noArrayIndexKey: HSL components are fixed order
            key={index}
            readOnly
            type="text"
            value={value}
