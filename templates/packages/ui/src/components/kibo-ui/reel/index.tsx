...
export const Reel = ({
  ...
  const [rawCurrentIndex, setCurrentIndexState] = useControllableState({
  ...
  const currentIndex = clampIndex(rawCurrentIndex ?? 0);

  useEffect(() => {
    if (rawCurrentIndex !== currentIndex) {
      setCurrentIndexState(currentIndex);
    }
  }, [rawCurrentIndex, currentIndex, setCurrentIndexState]);
  ...
  const setCurrentIndex = useCallback(
    ...
    [clampIndex, setCurrentIndexState]
  );
