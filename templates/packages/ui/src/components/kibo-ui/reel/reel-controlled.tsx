...
export function ReelControlledExample() {
  ...
  const handleJumpToItem = (index: number) => {
    const safeIndex = Math.max(0, Math.min(index, reelItems.length - 1));
  ...
  const safeCurrentIndex = Math.max(0, Math.min(currentIndex, reelItems.length - 1));
  const currentItem = reelItems[safeCurrentIndex];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-4 rounded-lg border p-4">
        ...
        <div className="text-gray-600 text-sm">
          <p>Current Index: {safeCurrentIndex}</p>
          ...
          <ReelHeader>
            <div className="text-white">
              ...
              <p className="text-sm opacity-80">
                Item {safeCurrentIndex + 1} of {reelItems.length}
              </p>
            </div>
          </ReelHeader>
